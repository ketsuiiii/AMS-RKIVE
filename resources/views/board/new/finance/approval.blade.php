                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-header-left">
                            <h3 class="">Approval Request Table</h3>
                        </div>
                        <div class="card-header-right">
                            <form action="{{ route(strtolower($role) . '.new.finance.approvalSearch') }}" method="get"
                                    ...
                                    @foreach ($budgetData as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="editModal{{ $item['id'] }}" tabindex="-{{ $item['id'] }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route(strtolower($role) . '.new.finance.approvalUpdate', $item['id']) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="row g-3">
