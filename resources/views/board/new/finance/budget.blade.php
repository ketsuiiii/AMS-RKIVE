                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-header-left">
                            <h3 class="">Budget Request Table</h3>
                        </div>
                        <div class="card-header-right">
                            <form action="{{ route(strtolower($role) . '.new.finance.budgetSearch') }}" method="get"
                                ...
                                <tbody>
                                    @foreach ($budgetData as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item['comment'] }}</td>
                                            <td>{{ $item['name'] }}</td>
                                            <td>{{ date('F j, Y', strtotime($item['start_date'])) }}</td>
                                            <td>{{ date('F j, Y', strtotime($item['end_date'])) }}</td>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route(strtolower($role) . '.new.finance.budgetUpdate', $item['id']) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="row g-3">
