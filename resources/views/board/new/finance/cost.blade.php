                    ...
                    <div class="card-body">
                        <div class="card-header">
                            <div class="card-header-left">
                                <h3 class="">Cost Request Table</h3>
                            </div>
                            <div class="card-header-right">
                                <form action="{{ route(strtolower($role) . '.new.finance.costSearch') }}" method="get"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{{ route(strtolower($role) . '.new.finance.costUpdate', $item['id']) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="row g-3">
