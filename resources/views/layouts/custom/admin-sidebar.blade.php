                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu" style="">
                            ...
                            <li><a href="{{ route(strtolower($role) . '.new.project') }}" data-bs-original-title=""
                                    title="">Project Management</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title active"
                            href="{{ route(strtolower($role) . '.new.allocation') }}" data-bs-original-title=""
                            title="">
                            <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu" style="">
                            <li><a href="{{ route(strtolower($role) . '.new.finance.budget') }}"
                                    data-bs-original-title="" title="">Budget</a></li>
                            <li><a href="{{ route(strtolower($role) . '.new.finance.cost') }}"
                                    data-bs-original-title="" title="">Cost</a></li>
                            <li><a href="{{ route(strtolower($role) . '.new.finance.expense') }}"
                                    data-bs-original-title="" title="">Expense</a></li>
                            <li><a href="{{ route(strtolower($role) . '.new.finance.payment') }}"
                                    data-bs-original-title="" title="">Payment</a></li>
                            <li><a href="{{ route(strtolower($role) . '.new.finance.approvalRequests') }}"
                                    data-bs-original-title="" title="">Approval Requests</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu" style="">
                            <li><a href="{{ route('admin.old.budgets') }}" data-bs-original-title=""
                                    title="">Budgets</a></li>
                            <li><a href="{{ route('admin.old.addbudgets') }}" data-bs-original-title=""
                                    title="">Additional Budget</a></li>
                            <li><a href="{{ route('admin.old.cashflow') }}" data-bs-original-title=""
                                    title="">Cashflow</a></li>
                            <li><a href="{{ route('admin.old.balance') }}" data-bs-original-title=""
                                    title="">Balance</a></li>
                            <li><a href="{{ route('admin.old.income') }}" data-bs-original-title=""
                                    title="">Income</a></li>
                            <li><a href="{{ route('admin.old.payable') }}" data-bs-original-title=""
                                    title="">Payable</a></li>
                            <li><a href="{{ route('admin.old.recievable') }}" data-bs-original-title=""
                                    title="">Receivable</a></li>
                            <li><a href="{{ route('admin.old.turnover') }}" data-bs-original-title=""
                                    title="">Turnover</a></li>
                            <li><a href="{{ route('admin.old.sales') }}" data-bs-original-title=""
                                    title="">Sales</a>
                            <li><a href="{{ route('admin.old.report') }}" data-bs-original-title=""
                                    title="">Reporting</a></li>
                            <li><a href="{{ route('admin.old.analytics') }}" data-bs-original-title=""
                                    title="">Analytics</a>
                            </li>
                        </ul>
                    </li>
